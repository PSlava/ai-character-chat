...
- **Избранное (лайки)** — кликабельная иконка ❤️ на карточках и странице персонажа; заполняется красным при добавлении; optimistic update через Zustand store; страница `/favorites` с grid избранных; очистка при выходе из аккаунта
