...
- Ссылки в сайдбаре: «Пользователи» + «Промпты» + «Жалобы» видны только админу
...
- 20 страниц: главная, авторизация, сброс пароля, OAuth callback, персонаж (с размытым фоном аватара), чат, создание (ручное + из текста + импорт), редактирование, профиль, **избранное**, **админ-промпты**, **админ-пользователи**, **админ-жалобы**, **о проекте**, **условия**, **конфиденциальность**, **FAQ**
...
- [ ] OAuth авторизация (GitHub, Discord)
