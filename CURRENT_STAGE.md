...
| GPT-OSS 120B | 6/10 | Строгая модерация |
| GPT-OSS 20B | 5/10 | Строгая модерация |
...
- **Авто-обновление реестров** — модели Groq и Cerebras обновляются из API каждый час, GPT-OSS (с модерацией) понижен в приоритете
