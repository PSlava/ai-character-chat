        ...
        jsonLd={{
          ...
          '@graph': [
            ...
            },
            {
              ...
              name: 'LangTutor',
              url: 'https://langtutor.app',
              logo: 'https://langtutor.app/favicon.svg',
              sameAs: [],
              contactPoint: {
                '@type': 'ContactPoint',
                contactType: 'customer support',
                email: 'hello@langtutor.app',
              },
            },
          ],
        }}
      ...
      <div ref={gridRef} className="p-4 md:p-6 max-w-5xl mx-auto">
        ...
        <div className="relative mb-6">
          ...
          <input
            ...
            className="w-full bg-neutral-800 border border-neutral-700 rounded-xl pl-10 pr-4 py-3 text-white placeholder-neutral-500 focus:outline-none focus:border-blue-500"
            autoComplete="off"
          />
        ...
        {featuredCharacter && !search && !activeTag && !loading && (
          <Link
            ...
            className="block mb-6 p-4 rounded-xl bg-gradient-to-r from-blue-950/50 to-neutral-800/50 border border-blue-500/20 hover:border-blue-500/40 transition-colors"
          >
            ...
            <div className="flex items-center gap-4">
              {featuredCharacter.avatar_url && (
                <div className="shrink-0">
                  <div className="w-16 h-16 rounded-full p-0.5 bg-gradient-to-br from-blue-500 to-emerald-600">
                    <img
