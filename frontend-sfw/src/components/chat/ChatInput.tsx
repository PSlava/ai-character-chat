      ...
      <div className="flex items-end gap-2 max-w-3xl mx-auto">
        {personaName && onGeneratePersonaReply && (
          <button
            ...
            className="p-3 text-emerald-400 hover:text-emerald-300 hover:bg-emerald-900/20 rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        ...
        <textarea
          ...
          rows={1}
          disabled={disabled}
          className="flex-1 bg-neutral-800 border border-neutral-700 rounded-xl px-4 py-3 text-white placeholder-neutral-500 focus:outline-none focus:border-blue-500 resize-none max-h-48 overflow-y-auto"
