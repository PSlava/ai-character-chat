        ...
        {!isStreaming && lastAssistant && onRegenerate && (
          <div className="flex justify-start gap-1">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 text-xs text-neutral-500 hover:text-blue-400 hover:bg-neutral-800 rounded-lg transition-colors"
            ...
            {editing ? (
              <div className="w-full max-w-[85%] sm:max-w-[75%] space-y-2">
                <textarea
                  ...
                  className="w-full bg-neutral-800 border border-neutral-700 rounded-lg px-3 py-2 text-white text-sm resize-none focus:outline-none focus:border-blue-500"
                  rows={3}
                  autoFocus
                />
                <div className="flex gap-2 justify-end">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 text-xs text-white bg-blue-600 hover:bg-blue-700 rounded-lg transition-colors disabled:opacity-50"
                  >
                    <Send size={13} />
                    {t('common.send')}
                  </button>
