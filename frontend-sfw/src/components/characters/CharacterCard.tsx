...
import { MessageCircle, Heart, GitFork } from 'lucide-react';
...
export const CharacterCard = memo(function CharacterCard({ character }: Props) {
  ...
  return (
    <Link
      ...
      className="block bg-neutral-800/50 border border-neutral-700/50 rounded-xl p-4 hover:border-blue-500/50 transition-all hover:bg-neutral-800"
    >
