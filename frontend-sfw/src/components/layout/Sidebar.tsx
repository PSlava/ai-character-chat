...
import { Home, Heart, Settings, Users, BarChart3, X, Sparkles, BookOpen, ChevronDown } from 'lucide-react';
          ...
          <aside className="relative w-64 h-full bg-neutral-900 border-r border-neutral-800 flex flex-col overflow-hidden">
            <div className="flex items-center justify-between p-3 border-b border-neutral-800">
              <span className="text-sm font-semibold flex items-center gap-1">
                ...
                <span className="text-neutral-300">Lang</span><span className="text-blue-500">Tutor</span>
              </span>
