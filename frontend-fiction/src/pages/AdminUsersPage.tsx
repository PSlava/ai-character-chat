    ...
    <div className="p-4 md:p-6 max-w-6xl mx-auto">
            ...
            {editingLimit && (
              <div className="absolute right-0 top-full mt-1 bg-neutral-800 border border-neutral-700 rounded-lg p-2 z-10 flex gap-2">
                <input
                  ...
                  className="w-24 px-2 py-1 bg-neutral-900 border border-neutral-600 rounded text-sm text-white focus:outline-none focus:border-purple-500"
                  onKeyDown={(e) => {
      ...
      <div className="relative mb-4 max-w-md">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2 bg-neutral-800 border border-neutral-700 rounded-lg text-sm text-white placeholder-neutral-500 focus:outline-none focus:border-purple-500"
        />
      </div>
