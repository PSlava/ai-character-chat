          ...
          '@graph': [
            {
              ...
              ...(character.avatar_url && { image: character.avatar_url.startsWith('/') ? `${window.location.origin}${character.avatar_url}` : character.avatar_url }),
              url: charUrl ? `${window.location.origin}${charUrl}` : undefined,
      ...
      {character.is_public && (
        <div className="mb-6">
          <ShareButtons
            ...
            url={`${window.location.origin}${charUrl || ''}`}
          />
        </div>
      )}
