          ...
          {step === 0 && (
            <>
              ...
              <button
                onClick={() => setStep(1)}
                disabled={!gender}
                className="w-full mt-4 flex items-center justify-center gap-2 px-4 py-2.5 bg-purple-600 hover:bg-purple-700 disabled:opacity-40 disabled:cursor-not-allowed text-white text-sm font-medium rounded-xl transition-colors"
              >
                {t('onboarding.next')}
          ...
          {step === 1 && (
            <>
              ...
              <button
                ...
                className="w-full mt-4 flex items-center justify-center gap-2 px-4 py-2.5 bg-purple-600 hover:bg-purple-700 text-white text-sm font-medium rounded-xl transition-colors"
              >
                {t('onboarding.finish')}
                <Sparkles size={16} />
              </button>
          ...
          {[0, 1].map((s) => (
            <div
              ...
              className={`w-1.5 h-1.5 rounded-full transition-colors ${
                s === step ? 'bg-purple-500' : 'bg-neutral-700'
              }`}
            />
          ))}
        </div>
