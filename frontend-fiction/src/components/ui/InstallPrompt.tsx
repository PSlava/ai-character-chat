    ...
    <div className="fixed bottom-16 left-4 right-4 z-50 sm:left-auto sm:right-4 sm:max-w-sm animate-slide-up">
      <div className="bg-neutral-800 border border-neutral-700 rounded-xl p-4 shadow-2xl">
        <div className="flex items-start gap-3">
          <div className="shrink-0 w-10 h-10 bg-purple-600 rounded-lg flex items-center justify-center">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex gap-2 mt-3">
              <button
                ...
                className="px-4 py-1.5 text-xs font-medium bg-purple-600 hover:bg-purple-700 text-white rounded-lg transition-colors"
              >
                {t('pwa.installButton')}
              </button>
              <button
