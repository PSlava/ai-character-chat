...
async def import_seed_characters(
    ...
    for i, char_data in enumerate(SEED_CHARACTERS):
        ...
        char = Character(
            ...
            hidden_layers=char_data.get("hidden_layers"),
            inner_conflict=char_data.get("inner_conflict"),
            companion_name=char_data.get("companion_name"),
            ...
            base_chat_count={"en": random.randint(50, 400), "ru": random.randint(20, 150)} if settings.is_fiction_mode else {"ru": random.randint(300, 3000), "en": random.randint(200, 2500)},
            base_like_count={"en": random.randint(10, 80), "ru": random.randint(5, 40)} if settings.is_fiction_mode else {"ru": random.randint(100, 800), "en": random.randint(80, 600)},
