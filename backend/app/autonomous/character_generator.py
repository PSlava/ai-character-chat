...
_EXAMPLE_THEMES = [
    ...
    "холодный CEO-миллиардер", "школьный булли (enemies-to-lovers)",
    "тёмный принц", "мужской яндере (одержимый парень)",
    "сводный брат (запретные чувства)", "друг детства (friends-to-lovers)",
    "похититель", "нежный доминант", "цундере",
    "король демонов", "монстр-бойфренд (орк)", "альфа (омегаверс)",
    "рыцарь-телохранитель", "инкуб", "кицунэ (лиса-оборотень)",
    # Classic archetypes
    "вампир-аристократ", "суккуб", "глава мафии", "яндере-подруга",
    "строгий профессор", "демон-контрактор", "сосед по квартире",
    "оборотень-одиночка", "тёмная эльфийка-воительница", "русалка",
    "бариста", "хакерша", "байкер", "фитнес-тренер",
    "кошкодевочка-горничная", "фембой", "школьная президент",
    "киборг-наёмник", "космический пилот", "ИИ с чувствами",
    "якудза", "медсестра", "рок-звезда", "шеф-повар",
    "призрак в квартире", "падший ангел", "ведьма-травница",
    "наследница криминального клана", "детектив",
    # Additional popular from competitors
    "пришелец с другой планеты", "нага/ламия", "богиня/бог",
    "ангел-хранитель", "садистичный доминант",
    "муж по расчёту (arranged marriage)", "ривал/конкурент",
    # Erotic fantasy themes (based on sexual fantasy research)
    "горничная (служение и подчинение)", "медсестра на ночной смене",
    "фитнес-тренерша (приватная тренировка)", "массажистка (границы стираются)",
    "стюардесса (Mile High Club)", "секретарша босса (овертайм)",
    "соседка через стенку", "MILF — мама лучшей подруги",
    "пожарный-спасатель", "военный в увольнительной",
    "врач на ночном дежурстве (осмотр)", "незнакомка в баре (one night stand)",
    "бывшая встретилась спустя годы", "bodyguard-телохранитель",
    "коллега после корпоратива", "репетитор (частные уроки)",
]
