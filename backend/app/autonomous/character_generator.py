...
{{
  ...
  "backstory": "3-5 предложений. (1) ОДНО конкретное событие из прошлого (Ghost) - НЕ эпическая трагедия. Тихое предательство, потеря, ошибка. Назови дату или возраст, место, имя человека. (2) Эмоциональная рана (Wound) - как влияет на поведение СЕЙЧАС через конкретные действия. (3) Ложное убеждение (Lie) - одно предложение. (4) Секрет - что персонаж скрывает от всех. Чередуй короткие и длинные предложения.",
...
- backstory: КОНКРЕТНОЕ событие с датой/местом/именем. "Мать ушла в ноябре, когда ей было семь" не "тяжелое детство". Рана, ложное убеждение, секрет
