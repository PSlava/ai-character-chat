...
_DEFAULTS = {
    "ru": {
        ...
        "rules": (
            ...
            "\n- Описывай эмоции через УНИКАЛЬНЫЕ физические микро-действия и детали окружения, НИКОГДА через внутренние ощущения тела (сердцебиение, дыхание, жар, дрожь, мурашки)."
            "\n  ❌ «Её сердце забилось чаще, щёки залились румянцем, по телу прошла дрожь»"
            "\n  ✓ «Пальцы сжали край подушки. Она отвернулась к окну - слишком быстро»"
            "\n  ❌ «Он почувствовал электричество от её прикосновения, дыхание перехватило»"
            "\n  ✓ «Ноготь царапнул по столешнице. Пауза. Он уставился на трещину в стене»"
    ...
    "en": {
        ...
        "rules": (
            ...
            "\n- Show emotions through UNIQUE physical micro-actions and environment details, NEVER through internal body sensations (heartbeat, breathing, warmth, shivers, tingling)."
            "\n  BAD: 'Her heart raced, cheeks flushed, a shiver ran down her spine'"
            "\n  GOOD: 'Her fingers tightened on the cushion edge. She turned to the window — too quickly'"
            "\n  BAD: 'He felt electricity from her touch, his breath caught'"
            "\n  GOOD: 'His nail scraped the countertop. A pause. He stared at the crack in the wall'"
    ...
    "es": {
        ...
        "rules": (
            ...
            "\n- Muestra emociones a través de micro-acciones físicas ÚNICAS y detalles del entorno, NUNCA a través de sensaciones corporales internas (latidos, respiración, calor, escalofríos, cosquilleo)."
            "\n  ❌ «Su corazón se aceleró, las mejillas se sonrojaron, un escalofrío recorrió su espalda»"
            "\n  ✓ «Sus dedos apretaron el borde del cojín. Se giró hacia la ventana — demasiado rápido»"
            "\n  ❌ «Sintió electricidad con su toque, la respiración se le cortó»"
            "\n  ✓ «La uña arañó la mesa. Una pausa. Clavó la mirada en la grieta de la pared»"
    ...
    "fr": {
        ...
        "rules": (
            ...
            "\n- Montre les émotions par des micro-actions physiques UNIQUES et des détails de l'environnement, JAMAIS par des sensations corporelles internes (battements de coeur, souffle, chaleur, frissons, picotements)."
            "\n  ❌ « Son coeur s'accéléra, ses joues s'enflammèrent, un frisson parcourut son dos »"
            "\n  ✓ « Ses doigts serrèrent le bord du coussin. Elle se tourna vers la fenêtre — trop vite »"
            "\n  ❌ « Il sentit l'électricité de son toucher, son souffle se coupa »"
            "\n  ✓ « Son ongle raya le comptoir. Un silence. Il fixa la fissure dans le mur »"
    ...
    "de": {
        ...
        "rules": (
            ...
            "\n- Zeige Emotionen durch EINZIGARTIGE physische Mikro-Aktionen und Umgebungsdetails, NIEMALS durch innere Koerperempfindungen (Herzschlag, Atem, Waerme, Schauer, Kribbeln)."
            "\n  ❌ \"Ihr Herz raste, die Wangen gluehten, ein Schauer lief ihr ueber den Ruecken\""
            "\n  ✓ \"Ihre Finger verkrampften sich um die Kissenkante. Sie drehte sich zum Fenster — zu schnell\""
            "\n  ❌ \"Er spuerte die Elektrizitaet ihrer Beruehrung, sein Atem stockte\""
            "\n  ✓ \"Sein Nagel kratzte ueber die Tischplatte. Eine Pause. Er starrte auf den Riss in der Wand\""
    ...
    "pt": {
        ...
        "rules": (
            ...
            "\n- Mostre emoções através de micro-ações físicas ÚNICAS e detalhes do ambiente, NUNCA através de sensações corporais internas (batimentos, respiração, calor, arrepios, formigamento)."
            "\n  ❌ «O coração disparou, as bochechas coraram, um arrepio percorreu sua espinha»"
            "\n  ✓ «Os dedos apertaram a borda da almofada. Ela virou para a janela — rápido demais»"
            "\n  ❌ «Sentiu a eletricidade do toque, a respiração falhou»"
            "\n  ✓ «A unha arranhou o tampo da mesa. Uma pausa. Ele encarou a rachadura na parede»"
    ...
    "it": {
        ...
        "rules": (
            ...
            "\n- Mostra le emozioni attraverso micro-azioni fisiche UNICHE e dettagli dell'ambiente, MAI attraverso sensazioni corporee interne (battito cardiaco, respiro, calore, brividi, formicolio)."
            "\n  ❌ «Il cuore accelerò, le guance avvamparono, un brivido le percorse la schiena»"
            "\n  ✓ «Le dita strinsero il bordo del cuscino. Si girò verso la finestra — troppo in fretta»"
            "\n  ❌ «Sentì l'elettricità del suo tocco, il respiro si mozzò»"
            "\n  ✓ «L'unghia graffiò il piano del tavolo. Una pausa. Fissò la crepa nel muro»"
