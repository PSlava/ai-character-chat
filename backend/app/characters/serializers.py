...
def character_to_dict(c: Character, language: str = None, is_admin: bool = False, rating_data: dict | None = None) -> dict:
    ...
    d = {
        ...
        "backstory": getattr(c, 'backstory', None),
        "hidden_layers": getattr(c, 'hidden_layers', None),
        "inner_conflict": getattr(c, 'inner_conflict', None),
        "companion_name": getattr(c, 'companion_name', None),
