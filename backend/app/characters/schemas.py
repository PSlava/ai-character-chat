...
class CharacterCreate(BaseModel):
    ...
    speech_pattern: str | None = Field(default=None, max_length=3000)
    backstory: str | None = Field(default=None, max_length=5000)
    hidden_layers: str | None = Field(default=None, max_length=5000)
    inner_conflict: str | None = Field(default=None, max_length=2000)
