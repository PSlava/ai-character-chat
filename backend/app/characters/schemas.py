...
class CharacterCreate(BaseModel):
    ...
    companion_name: str | None = Field(default=None, max_length=100)
    companion_role: str | None = Field(default=None, max_length=50)
    companion_personality: str | None = Field(default=None, max_length=500)
    companion_appearance: str | None = Field(default=None, max_length=300)
    companion_avatar_url: str | None = Field(default=None, max_length=2000)
    companion_speech_pattern: str | None = Field(default=None, max_length=300)
    companion_backstory: str | None = Field(default=None, max_length=500)
